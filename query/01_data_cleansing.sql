...
-- 1. Menghapus Redundansi Akun (Duplikat Email)
SELECT 
    email,
...
+----------------------------+------------------+-------------------+
| email                      | main_customer_id | first_joined_date |
+----------------------------+------------------+-------------------+
| baguspermata248@gmail.com  | CUST0045         | 2022-04-26        |
| rinalestari281@outlook.com | CUST0700         | 2023-03-31        |
| wulansuryadi729@yahoo.com  | CUST0188         | 2021-06-04        |
+----------------------------+------------------+-------------------+
3 rows in set (0.018 sec)

-- 2. Standarisasi Kategori Produk
-- Memperbaiki input admin yang tidak konsisten agar laporan pendapatan tidak terpecah.
...
-- Menyisihkan ulasan kosong agar siap digunakan oleh tim produk untuk analisis sentimen lanjutan.
